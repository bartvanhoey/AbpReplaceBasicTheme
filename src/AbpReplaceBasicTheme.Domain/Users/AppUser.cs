...
namespace AbpReplaceBasicTheme.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpReplaceBasicThemeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpReplaceBasicThemeEfCoreEntityExtensionMappings to extend the IdentityUser entity
