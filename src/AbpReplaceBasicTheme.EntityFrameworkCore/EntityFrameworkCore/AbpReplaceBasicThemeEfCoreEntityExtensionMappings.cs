...
{
    public static class AbpReplaceBasicThemeEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AbpReplaceBasicThemeModuleExtensionConfigurator CLASS (in the Domain.Shared project)
